function makeGetParameterAdd(name,val) {
	return ((val != null && val.length > 0) ? '&'+name+'='+encodeURIComponent(val) : '');
}
document.write('<sc'+'ript type="text/javascript" src="//tag.ladsp.com/pixel_p?advertiser_id='+smnAdvertiserId
